...
# In[3]
def crnn():
    x=image_input=Input(name='image_input',shape=(256,32,1),dtype='float32')
    """
    ...
    x=MaxPooling2D(pool_size=(2, 2), strides=(2, 2), name='pool3', padding='same')(x)# 32 8 256
...
traingen=crnnGenerator(imgpath=croptrainpath,labelpath=cropvaljson,imgw=256,imgh=32,batch_size=batch,
                      maxlen=12,inputlen=inputlength)
print('trainstart')
traingen.build_data()
print('valstart')
